...
The manuscript fits the journal because it combines geospatial exposure assessment, district-level risk mapping, remote-sensing climatology, and implications for natural-hazard risk reduction. Although the study is based in Peru, it addresses an internationally relevant problem: meteorological hazard maps alone may fail to identify populations with the greatest mortality when exposure and structural vulnerability differ.

The manuscript is original, is not under consideration elsewhere, and has been approved by all authors. The code, non-identifying aggregate outputs, and reproduction instructions are available at [GITHUB URL] and archived at [ZENODO DOI].
